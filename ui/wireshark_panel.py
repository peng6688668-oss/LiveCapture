...
class FilterPopup(QDialog):
    ...
    def __init__(self, column: int, header_label: str, unique_values: list,
        ...
        self.setStyleSheet(
            "QDialog { background: #f5f5f7; border: 2px solid #0078d4;"
            "  border-radius: 6px; }"
            "QLabel { color: #111111; background: transparent; }"
            "QLineEdit { background: #ffffff; color: #111111; border: 1px solid #c0c0c8;"
            "  border-radius: 3px; padding: 4px; }"
            "QCheckBox { color: #111111; spacing: 6px; padding: 2px; }"
            "QCheckBox::indicator { width: 14px; height: 14px; }"
            "QCheckBox::indicator:unchecked { border: 1px solid #999; background: #ffffff;"
            "  border-radius: 2px; }"
            "QCheckBox::indicator:checked { border: 1px solid #0078d4; background: #0078d4;"
            "  border-radius: 2px; }"
            "QPushButton { background: #e0e0e8; color: #111; border: 1px solid #c0c0c8;"
            "  border-radius: 3px; padding: 5px 12px; }"
            "QPushButton:hover { background: #d0d0dc; color: #000; }"
    ...
    def _flush_bus_queues(self):
        ...
        for i in range(6):
            ...
            if i < len(self._bus_models):
                ...
                # Auto-Scroll (sectionResized-Signal temporaer ignorieren)
